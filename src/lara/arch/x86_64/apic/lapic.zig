...
pub fn read(register: Registers) u32 {
    return mmio.read(u32, 0xfee00000 + pmm.hhdm_response.offset + @enumToInt(register));
}

pub fn write(register: Registers, value: u32) void {
    mmio.write(u32, 0xfee00000 + pmm.hhdm_response.offset + @enumToInt(register), value);
}
